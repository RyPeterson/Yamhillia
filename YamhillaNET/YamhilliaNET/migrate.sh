...
dotnet ef migrations add $1 --context Data/Design/DesignTimePostrgresContext --output-dir Migrations/PostgresMigrations
...
dotnet ef migrations add $1 --context Data/Design/DesignTimeSqliteContext --output-dir Migrations/SqliteMigrations